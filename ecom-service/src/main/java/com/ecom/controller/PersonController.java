...
public class PersonController {
	...
	public ResponseEntity<Person> createPerson(@RequestBody Person person) {
		log.info("Inside createPerson method from PersonController");
	...
	public ResponseEntity<Person> getPerson(@PathVariable Long id){
		log.info("Inside getPerson method from PersonController");
	...
	public ResponseEntity<List<Person>> getAllPersons(){
		log.info("Inside getAllPersons method from PersonController");
	...
	public ResponseEntity<HttpStatus> deletePerson(@PathVariable Long id){
		log.info("Inside deletePerson method from PersonController");
	...
	public ResponseEntity<Person> updatePerson(@Valid @RequestBody Person person){
		log.info("Inside updatePerson method from PersonController");
